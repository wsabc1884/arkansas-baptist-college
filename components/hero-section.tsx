...
export function HeroSection() {
  return (
    <section className="relative min-h-[70vh] overflow-hidden">
      {/* Background Image from ABC website */}
      <div className="absolute inset-0">
        <Image
          src="/images/hero-campus.jpg"
          alt="Arkansas Baptist College campus"
          fill
          className="object-cover"
          priority
        />
        <div className="absolute inset-0 bg-gradient-to-r from-[#3d1a5c]/90 via-[#3d1a5c]/70 to-transparent" />
      </div>

      {/* Content */}
      <div className="relative mx-auto flex min-h-[70vh] max-w-7xl flex-col items-start justify-center px-4 py-20 sm:px-6 lg:px-8">
        <p className="mb-4 text-sm font-semibold uppercase tracking-widest text-[#d4a736]">
        ...
        <div className="mt-10 flex flex-col gap-4 sm:flex-row">
          <Button size="lg" className="bg-[#d4a736] hover:bg-[#c49a2f] text-[#3d1a5c] font-semibold" asChild>
            <Link href="#">
              Apply Now
