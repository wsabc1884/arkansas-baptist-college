        ...
        <SectionWrapper>
          <div className="prose-abc mx-auto max-w-4xl">
            ...
            <div className="not-prose mt-4 flex flex-wrap gap-3">
              <a href="https://studentportal.literacypro.com/ar/providers/420/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 rounded-md bg-[#3d1a5c] px-5 py-2.5 text-sm font-semibold !text-white transition-colors hover:bg-[#3d1a5c]/90">Arkansas Baptist State Portal</a>
            </div>
