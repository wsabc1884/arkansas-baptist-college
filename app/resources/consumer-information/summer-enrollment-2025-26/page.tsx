...
export const metadata: Metadata = {
  title: "SUMMER II (U2) and SUMMER BRIDGE (U4) 2025-26 Enrollment | Arkansas Baptist College",
  description:
    "Enrollment snapshot for the SUMMER II (U2) and SUMMER BRIDGE (U4) 2025-26 terms at Arkansas Baptist College, including classification, gender, age, degree programs, majors, and geographic distribution.",
}
...
const ENROLLMENT_CHARTS: { src: string; alt: string; caption: string; width: number; height: number }[] = [
  ...
  {
    src: "/documents/summer-enrollment-2025-26/img8.png",
...
export default function SummerEnrollment2025Page() {
  return (
    <div className="min-h-screen">
      <main id="main-content">
        <PageHero
          title="SUMMER II (U2) and SUMMER BRIDGE (U4) 2025-26 Enrollment"
          subtitle="Consumer Information"
          description="Enrollment snapshot for the SUMMER II (U2) and SUMMER BRIDGE (U4) 2025-26 terms."
          breadcrumbs={[
            { label: "Resources", href: "/resources/consumer-information" },
            { label: "Consumer Information", href: "/resources/consumer-information" },
            { label: "Summer II & Summer Bridge 2025-26 Enrollment" },
          ]}
        />
        ...
        <SectionWrapper>
          ...
          <div className="mx-auto mt-8 max-w-4xl space-y-12">
            {/* Overall Enrollment */}
            <section>
              <h3 className="font-serif text-xl font-bold text-foreground">Overall Enrollment</h3>
              <div className="mt-4">
                <DataTable
            ...
            <section>
              <h3 className="font-serif text-xl font-bold text-foreground">Student Classification</h3>
            ...
            {/* Gender Distribution */}
            <section>
              <h3 className="font-serif text-xl font-bold text-foreground">Gender Distribution</h3>
              <div className="mt-4 grid gap-6 md:grid-cols-2">
                <div>
                  <h4 className="mb-3 font-semibold text-foreground">SUMMER II (U2)</h4>
                  <DataTable
                  ...
                  <p className="mt-2 text-xs text-muted-foreground">
                    The remaining records have missing gender values.
                  </p>
                </div>
                <div>
                  <h4 className="mb-3 font-semibold text-foreground">SUMMER BRIDGE (U4)</h4>
            ...
            {/* Average Student Age */}
            <section>
              <h3 className="font-serif text-xl font-bold text-foreground">Average Student Age</h3>
              <div className="mt-4">
                <DataTable
            ...
            {/* Degree Programs */}
            <section>
              <h3 className="font-serif text-xl font-bold text-foreground">Degree Programs</h3>
              <div className="mt-4 grid gap-6 md:grid-cols-2">
                <div>
                  <h4 className="mb-3 font-semibold text-foreground">SUMMER II (U2)</h4>
                  <DataTable
              ...
              <div className="prose-abc mt-4 max-w-none">
                <p>Business-related degrees continue to represent the largest share of student enrollment.</p>
              </div>
            </section>

            {/* Largest Academic Majors */}
            <section>
              <h3 className="font-serif text-xl font-bold text-foreground">Largest Academic Majors</h3>
              <div className="mt-4 grid gap-6 md:grid-cols-2">
                <div>
                  <h4 className="mb-3 font-semibold text-foreground">SUMMER II (U2)</h4>
                  <DataTable
              ...
              <div className="prose-abc mt-4 max-w-none">
                <p>
                  These data suggest continued student demand for business and professionally oriented academic
                  programs.
                </p>
              </div>
            </section>
            ...
            <section>
              <h3 className="font-serif text-xl font-bold text-foreground">Geographic Distribution</h3>
              <div className="prose-abc mt-2 max-w-none">
                <p>
            ...
            <section>
              <h3 className="font-serif text-xl font-bold text-foreground">Enrollment &amp; Student Outcomes Charts</h3>
              <div className="prose-abc mt-2 max-w-none">
                <p>
                  The following charts provide additional institutional data on enrollment, student demographics,
